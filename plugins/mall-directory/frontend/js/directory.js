jQuery(document).ready(function ($) {
    ...
    function filterStores() {
        ...
        renderedCount = 0;
        // Scroll may still be part-way down from before the filter/search ran —
        // reset it so the freshly-rendered cards (and their loading="lazy"
        // images) land back inside the visible viewport instead of off-screen
        // above it, and so the IntersectionObserver sentinel is reachable again.
