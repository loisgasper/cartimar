...
<svg id="cartimar-map-svg"
  ...
  <!-- CARTIMAR AVE & PARKING (OPEN) — spans under Plaza/Admin through Food Court/Save More -->
  <g class="area-zone area-zone--pin-only" data-area="Cartimar Ave &amp; Parking (Open)"
     tabindex="0" role="button" aria-label="Cartimar Avenue and Parking, Open">
    <title>Cartimar Ave &amp; Parking (Open)</title>
    <rect class="area-fill" x="410" y="565" width="1010" height="60" fill="#888888" stroke="#555555"></rect>
  </g>
